...
db.version(1).stores({
    meals: "++id, name, *categories, subCategory, *ingredients, sidesAllowed, isAllergen",
...
// Fires ONLY when the database is first created on a device
db.on("populate", function () {
    db.meals.bulkAdd([
        ...
        // --- AFTERNOON MEALS (RICE MEALS) ---
        {
            ...
            ingredients: [
                "Southwest Rice",
                "Chicken Tenders OR Ground Beef",
            ],
            sidesAllowed: 0,
            isAllergen: false,
        },
