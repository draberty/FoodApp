...
document.querySelectorAll(".Action").forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    $("MealCatDescription").textContent = descriptions[cat] || "Description Not Found";
...
AddBtn.addEventListener("click", () => openAddMealModal(currentSelectedMeals));
...
MealCatContainer.addEventListener("click", async (e) => {
  ...
  if (target.classList.contains("editBtn")) {
    ...
    const mealName = card.querySelector(".meal-title")?.textContent || "this meal";
